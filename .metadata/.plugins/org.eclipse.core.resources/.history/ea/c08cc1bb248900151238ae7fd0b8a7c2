...
public class Task_03 {
	public static void main(String[] args) {
		...
		System.out.println("Моля въведете двa последователни низа от символи без интервали.");
		String firstSymbols = scanner.next();
		String secondSymbols = scanner.next();

		System.out.println("Моля въведете две последователни едноцифрени числа.");
		...
		System.out.println("Разлики по позиции:");
		...
		while (!(firstPosition >= 0 && (firstPosition < firstSymbols.length() || firstPosition < secondSymbols.length()))
			...
			System.out.println("Несъществуваща позиция. Моля поитайте отново.");
